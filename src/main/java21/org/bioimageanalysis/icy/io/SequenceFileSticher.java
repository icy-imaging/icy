...
import org.bioimageanalysis.icy.common.string.StringUtil.AlphanumComparator;
...
public class SequenceFileSticher {
    ...
    public static class FilePosition implements Comparable<FilePosition> {
        ...
        @Contract(pure = true)
        private @Nullable PositionChunk getUnknownChunk(final int i) {
            int ind = 0;
     ...
     */
    public static SequenceFileGroup groupFiles(final SequenceFileImporter importer, final Collection<String> paths, final boolean findPosition, final FileFrame loadingFrame) throws InterruptedException, ClosedByInterruptException {
     ...
     */
    static @Nullable SequenceFileImporter tryOpen(final SequenceFileImporter importer, final String path, final boolean minimumMetadata)
        ...
        if (imp != null) {
            ...
            if (imp.getClass().getSimpleName().equalsIgnoreCase("LociImporterPlugin")) {
                ...
                imp.setReadOriginalMetadata(false);
            }
    ...
    private static @Nullable SequenceType getSequenceTypeFast(final String path) {
