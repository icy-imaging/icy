...
public class Canvas2D extends IcyCanvas2D implements ROIToolChangeListener {
    ...
    public Canvas2D(final Viewer viewer) {
        ...
        ApplicationMenuROI.addListener(this); // TODO: 23/01/2023 Change this by global listener
    }
    ...
    public void shutDown() {
        ...
        ApplicationMenuROI.removeListener(this); // TODO: 23/01/2023 Change this by global listener
    }
        ...
        boolean onMousePressed(final boolean consumed, final boolean left, final boolean right, final boolean control, final boolean shift) {
            ...
            if (!consumed) {
                ...
                if (left) {
                    ...
                    if (ROITool != null && !ROITool.isEmpty()) { // TODO: 23/01/2023 Check if it's ROI tool
