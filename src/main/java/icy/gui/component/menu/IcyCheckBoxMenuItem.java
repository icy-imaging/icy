...
public class IcyCheckBoxMenuItem extends JCheckBoxMenuItem {
    public IcyCheckBoxMenuItem(@Nullable final String text, @NotNull final IconCode defaultIcon, @NotNull final IconCode disabledIcon, @NotNull final IconCode selectedIcon, final float size) {
        super(text);
    ...
    public IcyCheckBoxMenuItem(@Nullable final String text, @NotNull final IconCode defaultIcon, @NotNull final IconCode disabledIcon, @NotNull final IconCode selectedIcon) {
        this(text, defaultIcon, disabledIcon, selectedIcon, LookAndFeelUtil.getDefaultIconSizeAsFloat());
    }

    public IcyCheckBoxMenuItem(@NotNull final IconCode defaultIcon, @NotNull final IconCode disabledIcon, @NotNull final IconCode selectedIcon) {
        this(null, defaultIcon, disabledIcon, selectedIcon);
    }

    public IcyCheckBoxMenuItem(@NotNull final IconCode defaultIcon, @NotNull final IconCode disabledIcon, @NotNull final IconCode selectedIcon, final float size) {
     ...
     */
    public IcyCheckBoxMenuItem(@NotNull final String text, @NotNull final IconCode defaultIcon) {
     ...
     */
    public IcyCheckBoxMenuItem(@NotNull final IconCode defaultIcon) {
     ...
     */
    public IcyCheckBoxMenuItem(@NotNull final String text, @NotNull final Icon icon) {
        super(text, icon);
    }
     ...
     */
    public IcyCheckBoxMenuItem(@NotNull final String text) {
        super(text);
    }
