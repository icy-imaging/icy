...
public class IcyCheckBoxMenuItem extends JCheckBoxMenuItem {
    public IcyCheckBoxMenuItem(final String text, final IconCode defaultIcon, final IconCode disabledIcon, final IconCode selectedIcon, final float size) {
        super(text);
    ...
    public IcyCheckBoxMenuItem(final String text, final IconCode defaultIcon, final IconCode disabledIcon, final IconCode selectedIcon) {
        this(text, defaultIcon, disabledIcon, selectedIcon, LookAndFeelUtil.getDefaultIconSizeAsFloat());
    }

    public IcyCheckBoxMenuItem(final IconCode defaultIcon, final IconCode disabledIcon, final IconCode selectedIcon) {
        this(null, defaultIcon, disabledIcon, selectedIcon);
    }

    public IcyCheckBoxMenuItem(final IconCode defaultIcon, final IconCode disabledIcon, final IconCode selectedIcon, final float size) {
     ...
     */
    public IcyCheckBoxMenuItem(final String text, final IconCode defaultIcon) {
     ...
     */
    public IcyCheckBoxMenuItem(final IconCode defaultIcon) {
     ...
     */
    public IcyCheckBoxMenuItem(final String text, final Icon icon) {
        super(text, icon);
    }
     ...
     */
    public IcyCheckBoxMenuItem(final String text) {
        super(text);
    }
