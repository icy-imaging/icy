...
public class IcyRadioButtonMenuItem extends JRadioButtonMenuItem {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGIconPack pack, final int size) {
        super(text);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGIconPack pack) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGIcon icon, final int size) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGIcon icon) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGIconPack pack, final int size) {
        super();
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGIconPack pack) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGIcon icon, final int size) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGIcon icon) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGIconPack pack, final int size) {
        super(action);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGIconPack pack) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGIcon icon, final int size) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGIcon icon) {
