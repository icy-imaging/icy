 ...
 */
public class IcyButtonNew extends JButton {
    private boolean flat;

    public IcyButtonNew(final String text, final IconCode icon, final float size) {
        super(text);
    ...
    public IcyButtonNew(final String text, final IconCode icon) {
        this(text, icon, LookAndFeelUtil.getDefaultIconSizeAsFloat());
    }

    public IcyButtonNew(final IconCode icon, final float size) {
        this(null, icon, size);
    }
     ...
     */
    public IcyButtonNew(final IconCode icon) {
        this(null, icon);
    }
     ...
     */
    public IcyButtonNew(final String text, final Icon icon) {
        super(text, icon);
        flat = false;
        init();
    }
     ...
     * Create a button with specified icon.
     */
    public IcyButtonNew(final Icon icon) {
        this(null, icon);
    }
     ...
     */
    public IcyButtonNew(final String text) {
        super(text);
        flat = false;
        init();
    }
     ...
     */
    @Deprecated
    public IcyButtonNew(final IcyAbstractAction action) {
        super(action);
        flat = false;
        init();
    }
