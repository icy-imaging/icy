...
public class ResourceNotFoundException extends JclException {
    ...
    public ResourceNotFoundException(@NotNull final String resource, final String message) {
        super(message);
    ...
    private void determineResourceType(@NotNull final String resourceName) {
