...
public class Saver {
     ...
     *
     * @param format {@link ImageFileFormat} we want to retrieve the saver.<br>
     *               Accepted values:<br>
     ...
     * <code>AVIWriter</code> : AVI video file<br>
     *
     * @param ext           Extension we want to retrieve the corresponding image writer.
     * @param defaultFormat default {@link ImageFileFormat} to use if <code>ext</code> is not recognized.<br>
     *                      Accepted values:<br>
     *                      {@link ImageFileFormat#TIFF}<br>
     *                      {@link ImageFileFormat#PNG}<br>
     *                      {@link ImageFileFormat#JPG}<br>
     ...
     * <code>AVIWriter</code> : AVI video file<br>
     *
     * @param file          File we want to retrieve the corresponding image writer.
     * @param defaultFormat default {@link ImageFileFormat} to use if <code>file</code> is not recognized.<br>
     *                      Accepted values:<br>
     *                      {@link ImageFileFormat#TIFF}<br>
     *                      {@link ImageFileFormat#PNG}<br>
     *                      {@link ImageFileFormat#JPG}<br>
     ...
     * @param fps          frame rate for AVI sequence save
     * @param multipleFile flag to indicate if images are saved in separate file.<br>
     ...
     *
     * @param writer    writer used to save sequence (define the image format, cannot be <code>null</code> at this point)
     * @param sequence  sequence to save
     * @param filePath  file name where we want to save sequence
     * @param posT      frame index to save (-1 to save all frame from input sequence)
     * @param posZ      slice index to save (-1 to save all slice from input sequence)
     ...
     *
     * @param writer   writer used to save sequence (define the image format, cannot be <code>null</code>)
     * @param sequence sequence to save
