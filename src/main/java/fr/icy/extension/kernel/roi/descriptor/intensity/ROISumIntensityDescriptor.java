...
package fr.icy.extension.kernel.roi.descriptor.intensity;
...
public class ROISumIntensityDescriptor extends ROIDescriptor {
     ...
     *
     * @param roi      the ROI on which we want to compute the intensity sum
     ...
     */
    public static double computeSumIntensity(final ROI roi, final Sequence sequence) throws UnsupportedOperationException, InterruptedException {
        return ROIUtil.computeIntensityDescriptors(roi, sequence, false).sum;
    }
}
