 ...
 */
package fr.icy.common.geom.point;
...
public abstract class Point3D implements Cloneable
{
    ...
    public Point3D normalize()
    {
        ...
        return new Double(getX() / mag, getY() / mag, getZ() / mag);
    }
    ...
    {
        return new Double(x + (getX() - x) / 2d, y + (getY() - y) / 2d, z + (getZ() - z) / 2d);
    }
    ...
    public static class Integer extends Point3D
    {
        ...
        {
            final Integer[] result = new Integer[input.length / 3];
