 ...
 */
package fr.icy.common.geom.rectangle;
...
import fr.icy.common.geom.shape.BoxShape3D;
...
public abstract class Rectangle3D extends BoxShape3D implements Shape3D, Cloneable
{
    ...
    public static class Integer extends Rectangle3D
    {
        ...
        public void setRect(double x, double y, double z, double sizeX, double sizeY, double sizeZ)
        {
            final Integer r = new Double(x, y, z, sizeX, sizeY, sizeZ).toInteger();
        ...
        public Rectangle3D createIntersection(Rectangle3D r)
        {
            final Integer result = new Integer();
