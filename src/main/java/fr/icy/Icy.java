...
import fr.icy.gui.dialog.IdConfirmDialog.Confirmer;
import fr.icy.gui.frame.ExitFrame;
import fr.icy.gui.frame.IcyExternalFrame;
import fr.icy.gui.frame.NewVersionFrame;
import fr.icy.gui.frame.SplashScreenWindow;
...
import fr.icy.gui.main.MainInterface;
import fr.icy.gui.main.MainInterfaceBatch;
import fr.icy.gui.main.MainInterfaceGui;
import fr.icy.io.FileUtil;
import fr.icy.io.Loader;
import fr.icy.model.cache.ImageCache;
import fr.icy.model.sequence.SequencePrefetcher;
...
/**
 * The {@code Icy} class is the entry point and core application handler for the Icy framework.
 * It contains methods to manage initialization, application state, command-line arguments,
 * plugin handling, and exit operations.
 * <p>
 * Key features:
 * - Handles startup and shutdown operations.
 * - Manages application and plugin lifecycle.
 * - Provides utility methods to interact with native libraries and application resources.
 *
