...
import fr.icy.system.preferences.XMLPreferences.XMLPreferencesRoot;
...
public class IcyPreferences {
    private static final String DEFAULT_NAME = "settings.xml";

    // load from default setting file
    private static final XMLPreferencesRoot root = new XMLPreferencesRoot(UserUtil.getIcyHomeDirectory().getAbsolutePath() + File.separator + DEFAULT_NAME);
