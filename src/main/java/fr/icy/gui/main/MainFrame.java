...
import fr.icy.gui.frame.IcyExternalFrame;
import fr.icy.gui.menu.ApplicationMenuBar;
import fr.icy.gui.toolbar.InspectorBar;
import fr.icy.gui.toolbar.ROIBar;
import fr.icy.gui.toolbar.StatusBar;
import fr.icy.gui.toolbar.container.InspectorPanel;
...
import fr.icy.system.FileDrop;
import fr.icy.system.FileDrop.FileDropListener;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame() throws HeadlessException {
        ...
        mainPane.setRightComponent(InspectorPanel.getInstance());
    ...
    public void init() {
        ...
        // main pane
        mainPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, centerPanel, InspectorPanel.getInstance());
    ...
    public void organizeCascade() {
        ...
        if (isDetachedMode()) {
            ...
            for (final GraphicsDevice dev : screenDevices)
        ...
        for (final GraphicsDevice dev : devices)
            organizeCascade(dev);
    }
     ...
     */
    protected void organizeCascade(final GraphicsDevice graphicsDevice) {
     ...
     */
    public void organizeTile(final @MagicConstant(intValues = {TILE_HORIZONTAL, TILE_VERTICAL, TILE_GRID}) int type) {
        // all screen devices
        final GraphicsDevice[] screenDevices = SystemUtil.getLocalGraphicsEnvironment().getScreenDevices();
        // screen devices to process
        final ArrayList<GraphicsDevice> devices = new ArrayList<>();
     ...
     */
    protected void organizeTile(final GraphicsDevice graphicsDevice, final int type) {
        final GraphicsConfiguration graphicsConfiguration = graphicsDevice.getDefaultConfiguration();
        final Rectangle bounds = graphicsConfiguration.getBounds();
