...
import fr.icy.model.colormap.IcyColorMapEvent;
import fr.icy.model.colormap.IcyColorMapListener;
...
public class ColormapPanel extends JPanel implements IcyColorMapListener {
    ...
    public ColormapPanel(final Viewer viewer, final LUTChannel lutChannel) {
        ...
        rgbBtn.addActionListener(e -> colormap.setType(IcyColorMapType.RGB));
        grayBtn.addActionListener(e -> colormap.setType(IcyColorMapType.GRAY));
        alphaBtn.addActionListener(e -> colormap.setType(IcyColorMapType.ALPHA));
        ...
        colormapComboBox = new JComboBox<>(new Vector<>(colormaps));
        colormapComboBox.setRenderer(new ColormapComboBoxRenderer(colormapComboBox));
        // limit size
        colormapComboBox.setMaximumSize(colormapComboBox.getMinimumSize());
