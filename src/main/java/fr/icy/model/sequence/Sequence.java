...
import fr.icy.gui.undo.IcyUndoableEdit;
...
import fr.icy.model.colormodel.IcyColorModelEvent;
import fr.icy.model.colormodel.IcyColorModelListener;
import org.bioimageanalysis.icy.model.image.*;
...
import org.bioimageanalysis.icy.model.sequence.edit.*;
...
public class Sequence implements SequenceModel, IcyColorModelListener, IcyBufferedImageListener, ChangeListener, ROIListener, OverlayListener, AutoCloseable {
    ...
    /**
     * Add the specified {@link SequenceModel.SequenceModelListener} to listeners list
     *
     * @param listener sequence listener
     */
    @Override
    ...
    /**
     * Remove the specified {@link SequenceModel.SequenceModelListener} from listeners
     *
     * @param listener sequence listener
     */
    @Override
