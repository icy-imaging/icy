...
public class UIntColorModel extends IcyColorModel
{
    ...
    /**
     * Create a new {@link UIntColorModel} with given {@link IcyColorSpace}
     * 
     * @param colorSpace
     *        {@link ColorSpace} instance
     * @param bits
     */
    public UIntColorModel(IcyColorSpace colorSpace, int[] bits)
    {
        super(colorSpace, DataType.UINT, bits);
    }
