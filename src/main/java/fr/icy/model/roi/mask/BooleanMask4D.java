 ...
 * 
 */
package fr.icy.model.roi.mask;

import fr.icy.common.collection.array.DynamicArray;
import fr.icy.common.geom.point.Point4D;
...
public class BooleanMask4D
{
    ...
    /**
     * Return an array of {@link Point4D.Integer} containing the contour/surface
     * points
     * of the 4D mask.<br>
    ...
    /**
     * Return an array of {@link Point4D.Integer} representing all points of the
     * current 4D mask.<br>
