...
public class ROI3DFlatPolygon extends ROI3DZShape {
    ...
    protected class ROI3DPolygonAnchor3D extends LineAnchor3D {
        public ROI3DPolygonAnchor3D(final Point3D position, final Color color, final Color selectedColor) {
    ...
    public ROI3DFlatPolygon(final FlatPolygon3D polygon3D) {
    ...
    public void setPolygon3D(final FlatPolygon3D polygon3D) {
        ...
        try {
            ...
            if (pts.size() == (ctrlPts.size() - 2)) {
                ...
                removeAllPoint();
                for (final Point2D pt : polygon3D.getPoints())
    ...
    protected void updateShape2DROI() {
        ...
        if (r instanceof final ROI2DPolygon roi) {
