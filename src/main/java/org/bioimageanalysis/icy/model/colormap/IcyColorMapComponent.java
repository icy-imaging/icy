...
public class IcyColorMapComponent implements XMLPersistent {
    ...
    public class ControlPoint implements Comparable<ControlPoint>, XMLPersistent {
        ...
        public ControlPoint(final int index, final int value, final boolean fixed) {
            super();
        ...
        public ControlPoint(final int index, final int value) {
         ...
         * Set control point position
         */
        public void setPosition(final int index, final int value) {
        ...
        @Override
        public int compareTo(final ControlPoint o) {
        ...
        public boolean equals(final Object obj) {
            if (obj instanceof final ControlPoint pt) {
    ...
    public IcyColorMapComponent(final IcyColorMap colorMap, final short initValue) {
        super();
    ...
    public IcyColorMapComponent(final IcyColorMap colorMap) {
     ...
     */
    public ControlPoint getControlPoint(final int index) {
     ...
     */
    public ControlPoint getControlPointWithIndex(final int index, final boolean create) {
     ...
     */
    public boolean hasControlPointWithIndex(final int index) {
     ...
     */
    public ControlPoint setControlPoint(final int index, final float value) {
     ...
     */
    public ControlPoint setControlPoint(final int index, final int value) {
     ...
     */
    public void removeControlPoint(final ControlPoint controlPoint) {
    ...
    public boolean isSame(final IcyColorMapComponent source) {
        //return controlPoints.equals(source.controlPoints) && (rawData == source.rawData) && map.equals(source.map);
        return controlPoints.equals(source.controlPoints) && (rawData == source.rawData) && Arrays.equals(map, source.map);
    }

    /**
     * Copy data from specified source colormap band
     */
    public void copyFrom(final IcyColorMapComponent source) {
        // nothing to do..
        if (isSame(source))
            return;
        ...
        for (final ControlPoint cp : source.controlPoints)
    ...
    public void copyFrom(final byte[] src) {
        ...
        final double srcOffsetStep = (double) src.length / IcyColorMap.SIZE;
        double srcOffset = 0;
     ...
     */
    public void copyFrom(final short[] src, final int shift) {
     ...
     */
    public void setNormalizedValue(final int index, final float value) {
        // flag to indicate we have raw data
        rawData = true;
     ...
     */
    public void controlPointChanged(final ControlPoint controlPoint) {
        controlPointsChanged();
    }
     ...
     *        added control point
     */
    public void controlPointAdded(final ControlPoint controlPoint) {
        controlPointsChanged();
    }
     ...
     */
    public void controlPointRemoved(final ControlPoint controlPoint) {
        controlPointsChanged();
    }
    ...
    public void onControlPointsChanged() {
        ...
        // get position only
        for (final ControlPoint point : controlPoints)
        ...
        try {
            if (rawData) {
                ...
                if (nodesPoint.size() == 0) {
                    ...
                    for (final Node nodePoint : nodesPoint) {
