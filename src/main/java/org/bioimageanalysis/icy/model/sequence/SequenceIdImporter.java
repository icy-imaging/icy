...
public interface SequenceIdImporter extends ImageProvider, AutoCloseable {
     ...
     */
    int FLAG_METADATA_MINIMUM = 0x0001;
    /**
     * Flag to indicate we want to load all possible metadata
     */
    int FLAG_METADATA_ALL = 0x0002;
     ...
     */
    boolean open(String id, int flags) throws UnsupportedFormatException, IOException, InterruptedException;
    ...
    default boolean isGroupFiles() {
        return false;
    }

    default void setGroupFiles(final boolean groupFiles) {

    }

    default boolean getReadOriginalMetadata() {
        return false;
    }

    default void setReadOriginalMetadata(final boolean readOriginalMetadata) {
