...
public class SequenceEvent implements CollapsibleEvent {
    public enum SequenceEventSourceType {
        SEQUENCE_TYPE, SEQUENCE_META, SEQUENCE_COLORMAP, SEQUENCE_COMPONENTBOUNDS, SEQUENCE_DATA, SEQUENCE_ROI, SEQUENCE_OVERLAY
    }
    ...
    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType) {
        this(sequence, sourceType, null, SequenceEventType.CHANGED, -1);
    }

    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType, final Object source) {
        this(sequence, sourceType, source, SequenceEventType.CHANGED, -1);
    }

    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType, final Object source, final int param) {
        this(sequence, sourceType, source, SequenceEventType.CHANGED, param);
    }

    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType, final SequenceEventType type) {
        this(sequence, sourceType, null, type, -1);
    }

    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType, final Object source, final SequenceEventType type) {
        this(sequence, sourceType, source, type, -1);
    }

    public SequenceEvent(final Sequence sequence, final SequenceEventSourceType sourceType, final Object source, final SequenceEventType type, final int param) {
        super();
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof final SequenceEvent e) {
            // same source type
            if ((e.getSequence() == sequence) && (e.getSourceType() == sourceType)) {
                return switch (sourceType) {
                    case SEQUENCE_META -> StringUtil.equals((String) e.getSource(), (String) source);
                    case SEQUENCE_COLORMAP, SEQUENCE_COMPONENTBOUNDS, SEQUENCE_DATA, SEQUENCE_TYPE -> true;
                    case SEQUENCE_OVERLAY, SEQUENCE_ROI -> ((e.getType() == type) && (e.getSource() == source));
                };
            }
        }
