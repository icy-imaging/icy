...
public abstract class IcyCanvas2D extends IcyCanvas {
    ...
    public IcyCanvas2D(final Viewer viewer) {
        super(viewer);
    ...
    public void setMouseImagePos(final double x, final double y) {
     ...
     */
    public void setMouseImagePos(final Point2D.Double point) {
     ...
     */
    protected Point2D.Double canvasToImageDelta(final int x, final int y, final double scaleX, final double scaleY, final double rot) {
        // get cos and sin
     ...
     */
    public Point2D.Double canvasToImageDelta(final int x, final int y) {
     ...
     * Convert specified canvas delta point to image delta point
     */
    public Point2D.Double canvasToImageDelta(final Point point) {
     ...
     */
    public Point2D.Double canvasToImageLogDelta(final int x, final int y, final double logFactor) {
     ...
     * The conversion is affected by zoom ratio but with the specified logarithm factor.
     */
    public Point2D.Double canvasToImageLogDelta(final int x, final int y) {
     ...
     */
    protected Point2D.Double canvasToImage(final int x, final int y, final int offsetX, final int offsetY, final double scaleX, final double scaleY, final double rot) {
        // get canvas center
        final double canvasCenterX = getCanvasSizeX() / 2d;
        final double canvasCenterY = getCanvasSizeY() / 2d;
     ...
     */
    public Point2D.Double canvasToImage(final int x, final int y) {
     ...
     * Convert specified canvas point to image point
     */
    public Point2D.Double canvasToImage(final Point point) {
     ...
     */
    public Rectangle2D.Double canvasToImage(final int x, final int y, final int w, final int h) {
     ...
     * Convert specified canvas rectangle to image rectangle
     */
    public Rectangle2D.Double canvasToImage(final Rectangle rect) {
     ...
     */
    protected Point imageToCanvasDelta(final double x, final double y, final double scaleX, final double scaleY, final double rot) {
        // apply scale
     ...
     */
    public Point imageToCanvasDelta(final double x, final double y) {
     ...
     * Convert specified image delta point to canvas delta point
     */
    public Point imageToCanvasDelta(final Point2D.Double point) {
     ...
     * Override this method if you want different transformation type.
     */
    protected Point imageToCanvas(final double x, final double y, final int offsetX, final int offsetY, final double scaleX, final double scaleY, final double rot) {
        // get canvas center
        final double canvasCenterX = getCanvasSizeX() / 2d;
        final double canvasCenterY = getCanvasSizeY() / 2d;
     ...
     */
    public Point imageToCanvas(final double x, final double y) {
     ...
     * Convert specified image point to canvas point
     */
    public Point imageToCanvas(final Point2D.Double point) {
     ...
     */
    public Rectangle imageToCanvas(final double x, final double y, final double w, final double h) {
        // convert each rectangle point
     ...
     * Convert specified image rectangle to canvas rectangle
     */
    public Rectangle imageToCanvas(final Rectangle2D.Double rect) {
     ...
     * Center image on specified image position in canvas
     */
    public void centerOnImage(final Point2D.Double pt) {
    ...
    public void centerImage() {
        centerOnImage(getImageSizeX() / 2d, getImageSizeY() / 2d);
    }
     ...
     */
    public Dimension canvasToViewer(final Dimension dim) {
     ...
     */
    public Dimension viewerToCanvas(final Dimension dim) {
        final Dimension canvasViewSize = getCanvasSize();
        final Dimension viewerSize = viewer.getSize();
        final Dimension result = new Dimension(dim);
