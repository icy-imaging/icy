...
import org.bioimageanalysis.icy.common.math.Interpolator;
...
import org.bioimageanalysis.icy.model.overlay.ImageOverlay;
...
public class Canvas2D extends IcyCanvas2D implements ROIToolChangeListener {
    ...
    public void centerOnImage(final double x, final double y) {
        ...
        setOffset((int) (smoothTransform.getDestValue(TRANS_X) + Math.round(newTrans.x)), (int) (smoothTransform.getDestValue(TRANS_Y) + Math.round(newTrans.y)), false);
    }
    ...
    protected void centerMouseOnImage() {
        setMouseImagePos(getImageSizeX() / 2f, getImageSizeY() / 2f);
    }
     ...
     *
     * @param center if true then zoom is centered to current view else zoom is
     ...
     *
     * @param mouseCentered if true the current mouse image position will becomes the
    ...
    protected void synchronizeCanvas(final List<IcyCanvas> canvasList, final IcyCanvasEvent event, final boolean processAll) {
        ...
        if (isSynchOnSlice()) {
            if (processAll || (type == IcyCanvasEvent.IcyCanvasEventType.POSITION_CHANGED)) {
        ...
        if (isSynchOnCursor()) {
            ...
            if (processAll || (type == IcyCanvasEvent.IcyCanvasEventType.MOUSE_IMAGE_POSITION_CHANGED)) {
                // no information about dimension --> set all
                if (processAll || (dim == DimensionId.NULL)) {
        ...
        switch (type) {
            ...
            case MOUSE_IMAGE_POSITION_CHANGED:
                ...
                if (!canvasView.handlingMouseMoveEvent && !canvasView.isDragging() && !isSynchSlave()) {
                    ...
                    final MouseEvent mouseEvent = new MouseEvent(this, MouseEvent.MOUSE_MOVED, System.currentTimeMillis(), 0, mousePos.x, mousePos.y, mouseAbsolutePos.x, mouseAbsolutePos.y, 0, false, 0);
    ...
    public class CanvasMap extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
        ...
        public void mouseWheelMoved(final MouseWheelEvent e) {
            ...
            // send to canvas view
            if (canvasView.onMouseWheelMoved(e.isConsumed(), e.getWheelRotation(), EventUtil.isLeftMouseButton(e), EventUtil.isRightMouseButton(e), EventUtil.isControlDown(e), EventUtil.isShiftDown(e)))
                e.consume();
        }
        ...
        protected void paintComponent(final Graphics g) {
            ...
            if (trans != null) {
                final Graphics2D g2 = (Graphics2D) g.create();
                final List<CanvasView.ImageCache.ImageCacheTile> tiles = canvasView.imageCache.getImageAsTiles();
    ...
    public class CanvasView extends JPanel implements ActionListener, MouseWheelListener, MouseListener, MouseMotionListener {
        public class ImageCache implements Runnable {
             ...
             * image cache
             */
            private final List<ImageCacheTile> tiles;
                    ...
                    try {
                        {
                            ...
                            // get tiles list
                            final List<Rectangle> newTiles = ImageUtil.getTileList(icyImage.getSizeX(), icyImage.getSizeY(), ImageCacheTile.TILE_SIZE, ImageCacheTile.TILE_SIZE);
        ...
        private final SingleProcessor cursorUpdator;
        Dimension lastSize;
        boolean actived;
            ...
            if (!consumed) {
                ...
                if (left) {
                    ...
                    if (ROITool != null && !ROITool.isEmpty()) {
                        ...
                        final String roiClassName = ROITool;
        ...
        public void mousePressed(final MouseEvent e) {
            ...
            // process
            if (onMousePressed(e.isConsumed(), EventUtil.isLeftMouseButton(e), EventUtil.isRightMouseButton(e), EventUtil.isControlDown(e), EventUtil.isShiftDown(e)))
                e.consume();
        }
        ...
        public void mouseDragged(final MouseEvent e) {
            ...
            // process
            if (onMouseDragged(e.isConsumed(), e.getPoint(), EventUtil.isLeftMouseButton(e), EventUtil.isRightMouseButton(e), EventUtil.isControlDown(e), EventUtil.isShiftDown(e)))
                e.consume();
        }
        ...
        public void mouseWheelMoved(final MouseWheelEvent e) {
            ...
            // process
            if (onMouseWheelMoved(e.isConsumed(), e.getWheelRotation(), EventUtil.isLeftMouseButton(e), EventUtil.isRightMouseButton(e), EventUtil.isControlDown(e), EventUtil.isShiftDown(e)))
                e.consume();
        }
