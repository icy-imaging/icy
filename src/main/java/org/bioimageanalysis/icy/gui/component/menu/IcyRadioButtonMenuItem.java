...
public class IcyRadioButtonMenuItem extends JRadioButtonMenuItem {
    ...
    /**
     * Create a {@link JRadioButtonMenuItem} with specified text, SVG icons for each state (default, disabled, selected and disabled-selected) and custom size.
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull IcyIconPack pack, final int size) {
        super(text);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
    ...
    /**
     * Create a {@link JRadioButtonMenuItem} with specified text, SVG icons for each state (default, disabled, selected and disabled-selected) and default size.
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull IcyIconPack pack) {
        this(text, pack, LookAndFeelUtil.getDefaultIconSize());
    }

    /**
     * Create a {@link JRadioButtonMenuItem} with specified text, same SVG icon for each state (default, disabled, selected and disabled-selected) and custom size.
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGResource icon, final int size) {
        this(text, new IcyIconPack(icon), size);
    }

    /**
     * Create a {@link JRadioButtonMenuItem} with specified text, same SVG icon for each state (default, disabled, selected and disabled-selected) and default size.
     */
    public IcyRadioButtonMenuItem(final @NotNull String text, final @NotNull SVGResource icon) {
    ...
    /**
     * Create a {@link JRadioButtonMenuItem} with specified SVG icons for each state (default, disabled, selected and disabled-selected) and custom size, but without text.
     */
    public IcyRadioButtonMenuItem(final @NotNull IcyIconPack pack, final int size) {
        super();
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
    ...
    /**
     * Create a {@link JRadioButtonMenuItem} with specified SVG icons for each state (default, disabled, selected and disabled-selected) and default size, but without text.
     */
    public IcyRadioButtonMenuItem(final @NotNull IcyIconPack pack) {
        this(pack, LookAndFeelUtil.getDefaultIconSize());
    }

    /**
     * Create a {@link JRadioButtonMenuItem} with same SVG icon for each state (default, disabled, selected and disabled-selected) and custom size, but without text.
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGResource icon, final int size) {
        this(new IcyIconPack(icon), size);
    }

    /**
     * Create a {@link JRadioButtonMenuItem} with same SVG icon for each state (default, disabled, selected and disabled-selected) and default size, but without text.
     */
    public IcyRadioButtonMenuItem(final @NotNull SVGResource icon) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull IcyIconPack pack, final int size) {
        super(action);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull IcyIconPack pack) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGResource icon, final int size) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action, final @NotNull SVGResource icon) {
     ...
     */
    public IcyRadioButtonMenuItem(final @NotNull Action action) {
        super(action);
        iconPack = null;
