...
public class HistogramPanel extends BorderedPanel {
    public interface HistogramPanelListener extends EventListener {
         ...
         */
        void histogramNeedRefresh(HistogramPanel source);
    }
     ...
     * @see #getBinSize(int)
     */
    public double getAdjustedBinSize(final int index) {
        // cache
     ...
     *
     * @see Histogram#getBinSize(int)
     */
    public int getBinSize(final int index) {
        return histogram.getBinSize(index);
    }

    /**
     * @see Histogram#getBinNumber()
     */
     ...
     */
    public void setMinMaxIntValues(final double min, final double max, final boolean intType) {
     ...
     */
    public void setLogScaling(final boolean value) {
        if (logScaling != value) {
            logScaling = value;
            refreshDataCache();
        }
     ...
     */
    public void setUseLAFColors(final boolean value) {
    ...
    protected boolean hasSameProperties(final Histogram h) {
        return (histogram.getBinNumber() == h.getBinNumber()) &&
                ...
                (histogram.isIntegerType() == h.isIntegerType());
    }
     ...
     */
    public int dataToPixel(final double value) {
     ...
     */
    public double pixelToData(final int value) {
    ...
    protected void fireHistogramNeedRefresh() {
        for (final HistogramPanelListener l : listenerList.getListeners(HistogramPanelListener.class))
            l.histogramNeedRefresh(this);
    }

    public void addListener(final HistogramPanelListener l) {
        listenerList.add(HistogramPanelListener.class, l);
    }

    public void removeListener(final HistogramPanelListener l) {
