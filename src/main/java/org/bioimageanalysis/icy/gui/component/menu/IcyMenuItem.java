...
public class IcyMenuItem extends JMenuItem {
     ...
     */
    public IcyMenuItem(final @NotNull String text, final @NotNull IcyIconPack pack, final int size) {
        super(text);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyMenuItem(final @NotNull String text, final @NotNull IcyIconPack pack) {
     ...
     */
    public IcyMenuItem(final @NotNull String text, final @NotNull SVGResource icon, final int size) {
     ...
     */
    public IcyMenuItem(final @NotNull String text, final @NotNull SVGResource icon) {
     ...
     */
    public IcyMenuItem(final @NotNull IcyIconPack pack, final int size) {
        super();
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyMenuItem(final @NotNull IcyIconPack pack) {
    ...
    public IcyMenuItem(final @NotNull SVGResource icon, final int size) {
     ...
     */
    public IcyMenuItem(final @NotNull SVGResource icon) {
     ...
     */
    public IcyMenuItem(final @NotNull Action action, final @NotNull IcyIconPack pack, final int size) {
        super(action);
        iconPack = pack;
        iconSize = size;
        setSVGIcons();
     ...
     */
    public IcyMenuItem(final @NotNull Action action, final @NotNull IcyIconPack pack) {
     ...
     */
    public IcyMenuItem(final @NotNull Action action, final @NotNull SVGResource icon, final int size) {
     ...
     */
    public IcyMenuItem(final @NotNull Action action, final @NotNull SVGResource icon) {
