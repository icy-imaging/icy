...
import org.bioimageanalysis.icy.gui.component.renderer.ImageTableCellRenderer;
import org.bioimageanalysis.icy.gui.roi.RoiSettingFrame;
import org.bioimageanalysis.icy.gui.listener.ActiveSequenceListener;
import org.bioimageanalysis.icy.gui.toolbar.panel.ToolbarPanel;
...
import org.bioimageanalysis.icy.system.thread.InstanceProcessor;
...
import org.bioimageanalysis.extension.kernel.roi.descriptor.intensity.ROIMaxIntensityDescriptor;
import org.bioimageanalysis.extension.kernel.roi.descriptor.intensity.ROIMeanIntensityDescriptor;
import org.bioimageanalysis.extension.kernel.roi.descriptor.intensity.ROIMinIntensityDescriptor;
import org.bioimageanalysis.extension.kernel.roi.descriptor.intensity.ROISumIntensityDescriptor;
...
public abstract class AbstractRoisPanel extends ToolbarPanel implements ActiveSequenceListener, TextChangeListener, ListSelectionListener, ExtensionLoader.ExtensionLoaderListener {
    ...
    public static class BaseColumnInfo implements Comparable<BaseColumnInfo> {
        ...
        protected int getDefaultOrder() {
            ...
            // TODO Replace this with default properties (not static call)
            order++;
            if (StringUtil.equals(id, ROIIconDescriptor.ID))
                return order;
            order++;
