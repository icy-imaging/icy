...
public class RangeSliderUI extends BasicSliderUI {
    ...
    public void paintTrack(final Graphics g) {
        ...
        final Color accent = Objects.requireNonNull(LookAndFeelUtil.getUIDefaults()).getColor("Slider.trackValueColor");
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            final int y = 2;
            g2d.drawLine(lowerX - trackBounds.x, y, upperX - trackBounds.x, y);
            ...
            g2d.setStroke(new BasicStroke(2f));
            final int x = 2;
            g2d.drawLine(x, lowerY - trackBounds.y, x, upperY - trackBounds.y);
    ...
    private void paintLowerThumb(final Graphics g) {
        ...
        final Color accent = Objects.requireNonNull(LookAndFeelUtil.getUIDefaults()).getColor("Slider.thumbColor");
