 ...
 */
package org.bioimageanalysis.icy.gui.viewer;
...
import org.bioimageanalysis.icy.gui.component.panel.ColorComponent;
...
public class MouseImageInfosPanel extends JPanel {
     ...
     */
    public void setInfoXVisible(final boolean value) {
     ...
     */
    public void setInfoYVisible(final boolean value) {
     ...
     */
    public void setInfoZVisible(final boolean value) {
     ...
     */
    public void setInfoTVisible(final boolean value) {
     ...
     */
    public void setInfoCVisible(final boolean value) {
     ...
     */
    public void setInfoDataVisible(final boolean value) {
     ...
     */
    public void setInfoColorVisible(final boolean value) {
    ...
    public void updateInfos(final IcyCanvas canvas) {
        final Sequence seq;
            ...
            if ((image != null) && (image.isInside(xi, yi))) {
                try {
                    ...
                    if (ci == -1) {
                        ...
                        dataValue.setText(ArrayUtil.array1DToString(image.getDataCopyC(xi, yi), image.getDataType().isSigned(), false, " : ", 5));
                    }
                    else {
