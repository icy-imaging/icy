...
import org.bioimageanalysis.icy.gui.dialog.SaverDialog;
...
import org.bioimageanalysis.icy.gui.lut.LUTViewer;
import org.bioimageanalysis.icy.gui.plugin.PluginComboBoxRenderer;
...
public class Viewer extends IcyFrame implements KeyListener, SequenceListener, IcyCanvasListener, ExtensionLoader.ExtensionLoaderListener {
    ...
    public void setCanvas(final String pluginClassName) {
        ...
        if ((canvas == null) || !StringUtil.equals(canvas.getClass().getName(), IcyCanvas.getCanvasClassName(pluginClassName))) {
            try {
                ...
                // VTK Canvas ?
                if (className.endsWith(".VtkCanvasPlugin")) {
    ...
    /**
     * @see IcyCanvas#getRenderedImage(int, int, int, boolean)
     */
    ...
    /**
     * @see IcyCanvas#getRenderedSequence(boolean, ProgressListener)
     */
