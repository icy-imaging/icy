...
public class IcyFrame implements InternalFrameListener, WindowListener, ImageObserver, PropertyChangeListener {
    public final class SwitchStateAction extends IcyAbstractAction {
     ...
     */
    static final ArrayList<IcyFrame> frames = new ArrayList<>();
     ...
     */
    public static ArrayList<IcyFrame> getAllFrames(final Class<?> frameClass) {
        final ArrayList<IcyFrame> result = new ArrayList<>();

        if (frameClass != null) {
            synchronized (frames) {
                for (final IcyFrame frame : frames)
     ...
     */
    public static IcyFrame findIcyFrame(final JInternalFrame frame) {
        synchronized (frames) {
            for (final IcyFrame f : frames)
    ...
    public IcyFrame(final String title) {
        this(title, false, true, false, false, true);
    }

    public IcyFrame(final String title, final boolean resizable) {
        this(title, resizable, true, false, false, true);
    }

    public IcyFrame(final String title, final boolean resizable, final boolean closable) {
     ...
     */
    protected IcyExternalFrame createExternalFrame(final String title) {
     ...
     */
    protected IcyInternalFrame createInternalFrame(final String title, final boolean resizable, final boolean closable, final boolean maximizable, final boolean iconifiable) {
     ...
     */
    public void setSwitchStateItemVisible(final boolean value) {
        // don't try to go further
        if (headless)
            return;
     ...
     */
    public InputMap getInputMap(final int condition) {
        // don't try to go further
        if (headless)
            return null;
     ...
     */
    public void setSyncProcess(final boolean syncProcess) {
     ...
     */
    private void fireFrameActivated(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     * @param e Icy frame event
     */
    private void fireFrameDeactivated(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     * @param e Icy frame event
     */
    private void fireFrameClosing(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
            l.icyFrameClosing(e);
    }
     ...
     * @param e Icy frame event
     */
    private void fireFrameClosed(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
            l.icyFrameClosed(e);
    }
     ...
     * @param e Icy frame event
     */
    private void fireFrameIconified(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     * @param e Icy frame event
     */
    private void fireFrameDeiconified(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     * @param e Icy frame event
     */
    private void fireFrameOpened(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
            l.icyFrameOpened(e);
    }
     ...
     * @param e Icy frame event
     */
    void fireFrameInternalized(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     * @param e Icy frame event
     */
    void fireFrameExternalized(final IcyFrameEvent e) {
        for (final IcyFrameListener l : frameEventListeners.getListeners(IcyFrameListener.class))
     ...
     */
    public void addFrameListener(final IcyFrameListener l) {
        // don't try to go further
        if (headless)
            return;
     ...
     * @param l Icy frame listener
     */
    public void removeFrameListener(final IcyFrameListener l) {
        // don't try to go further
        if (headless)
            return;
     ...
     * @param e event
     */
    public void frameClosed(final AWTEvent e) {
        // don't try to go further
        if (headless)
            return;
