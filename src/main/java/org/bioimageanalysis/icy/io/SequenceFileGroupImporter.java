...
import org.bioimageanalysis.icy.io.SequenceFileSticher.SequenceIdent;
import org.bioimageanalysis.icy.io.SequenceFileSticher.SequencePosition;
import org.bioimageanalysis.icy.io.SequenceFileSticher.SequenceType;
import org.bioimageanalysis.icy.model.OMEUtil;
import org.bioimageanalysis.icy.model.colormap.IcyColorMap;
import org.bioimageanalysis.icy.model.image.AbstractImageProvider;
...
public class SequenceFileGroupImporter extends AbstractImageProvider implements SequenceFileImporter {
    ...
    /**
     * Better to use {@link #open(Collection, int)} or {@link #open(SequenceFileGroup, int)} for this importer
     */
    @Override
     ...
     * Prefer to use {@link SequenceFileSticher#groupFiles(SequenceFileImporter, Collection, boolean, org.bioimageanalysis.icy.gui.frame.progress.FileFrame)}
     * then use {@link #open(SequenceFileGroup, int)} instead.
     */
    ...
    protected boolean openImporter(final SequenceFileImporter result, final String path) throws Exception {
        ...
        if (result.getClass().getSimpleName().equalsIgnoreCase("LociImporterPlugin"))
            result.setGroupFiles(false);
