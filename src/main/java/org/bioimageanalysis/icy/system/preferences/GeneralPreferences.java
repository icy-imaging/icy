...
import org.bioimageanalysis.icy.model.roi.ROI.ROIPainter;
...
public class GeneralPreferences {
    ...
    public static void setExitConfirm(final boolean value) {
        prefConfirms.putBoolean(ID_CONFIRM_EXIT, value);
    }

    public static void setSaveNewSequence(final boolean value) {
        prefGeneral.putBoolean(ID_SAVE_NEW_SEQUENCE, value);
    }

    public static void setSequencePersistence(final boolean value) {
        prefGeneral.putBoolean(ID_SEQUENCE_PERSISTENCE, value);
    }

    public static void setAutomaticUpdate(final boolean value) {
        prefGeneral.putBoolean(ID_AUTO_UPDATE, value);
    }

    public static void setUsageStatisticsReport(final boolean value) {
        prefGeneral.putBoolean(ID_USAGE_STATS_REPORT, value);
    }

    public static void setLastUpdateCheckTime(final long time) {
        prefGeneral.putLong(ID_LAST_UPDATECHECK_TIME, time);
    }

    public static void setRibbonMinimized(final boolean value) {
        prefGeneral.putBoolean(ID_RIBBON_MINIMIZED, value);
    }

    public static void setMultiWindowMode(final boolean value) {
        prefGeneral.putBoolean(ID_DETACHED_MODE, value);
    }

    public static void setAlwaysOnTop(final boolean value) {
        prefGeneral.putBoolean(ID_ALWAYS_ON_TOP, value);
    }

    public static void setStatupTooltip(final boolean value) {
        prefGeneral.putBoolean(ID_STARTUP_TOOLTIP, value);
    }

    public static void setLoaderFolder(final String value) {
        prefGeneral.put(ID_LOADER_FOLDER, value);
    }

    public static void setResultFolder(final String value) {
        prefGeneral.put(ID_RESULT_FOLDER, value);
    }

    public static void setUserLogin(final String value) {
    ...
    public static void setUserEmail(final String value) {
        prefGeneral.put(ID_USER_EMAIL, value);
    }

    public static void setGuiFontSize(final int value) {
        prefGeneral.putInt(ID_GUI_FONT_SIZE, value);
    }

    public static void setGuiSkin(final String value) {
        prefGeneral.put(ID_GUI_SKIN, value);
    }

    public static void setHistorySize(final int value) {
        prefGeneral.putInt(ID_HISTORY_SIZE, value);
    }

    public static void setOutputLogSize(final int value) {
        prefGeneral.putInt(ID_OUTPUT_LOG_SIZE, value);
    }

    public static void setOutputLogFile(final boolean value) {
        prefGeneral.putBoolean(ID_OUTPUT_LOG_FILE, value);
    }

    public static void setVirtualMode(final boolean value) {
