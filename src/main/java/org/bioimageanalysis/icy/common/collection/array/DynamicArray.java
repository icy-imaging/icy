...
public abstract class DynamicArray {
     ...
     *        4).
     */
    public static DynamicArray create(final DataType type, final int granularity) {
        return switch (type.getJavaType()) {
            case BYTE -> new Byte(granularity);
     ...
     * @param type object
     */
    public static DynamicArray create(final DataType type) {
        return create(type, 4);
    }

    public static class Generic extends DynamicArray {
        public void addSingle(final Object value) {
        ...
        @Override
        protected int getArraySize(final Object array) {
    ...
    public static class Byte extends DynamicArray {
         ...
         *        4).
         */
        public Byte(final int granularity) {
            super(granularity);
        }
    ...
    public static class Short extends DynamicArray {
         ...
         *        4).
         */
        public Short(final int granularity) {
            super(granularity);
        }
    ...
    public static class Int extends DynamicArray {
         ...
         *        (default = 4).
         */
        public Int(final int granularity) {
            super(granularity);
        }
    ...
    public static class Long extends DynamicArray {
         ...
         *        4).
         */
        public Long(final int granularity) {
            super(granularity);
        }
    ...
    public static class Float extends DynamicArray {
         ...
         *        4).
         */
        public Float(final int granularity) {
            super(granularity);
        }
    ...
    public static class Double extends DynamicArray {
         ...
         *        4).
         */
        public Double(final int granularity) {
            super(granularity);
        }
    ...
    protected class ArrayBlock {
        ...
        protected void get(final Object out, final int inOffset, final int outOffset, final int len) {
            System.arraycopy(array, inOffset, out, outOffset, len);
        }

        @SuppressWarnings("SuspiciousSystemArraycopy")
        protected void add(final Object in, final int inOffset, final int len) {
            System.arraycopy(in, inOffset, array, size, len);
            size += len;
        }

        @SuppressWarnings("SuspiciousSystemArraycopy")
        protected void put(final Object in, final int inOffset, final int outOffset, final int len) {
    ...
    DynamicArray(final int granularity) {
        super();
    ...
    protected void checkCapacity(final int size) {
    ...
    protected ArrayBlock getBlockFromOffset(final int offset) {
    ...
    protected ArrayBlock getAvailableBlock(final boolean create) {
    ...
    public void addAll(final DynamicArray in) {
    ...
    public void get(final Object out, final int inOffset, final int outOffset, final int len) {
    ...
    public void add(final Object in, final int inOffset, final int len) {
        int offset = inOffset;
        int cnt = len;
        while (cnt > 0) {
            final ArrayBlock block = getAvailableBlock(true);
    ...
    public void put(final Object in, final int inOffset, final int outOffset, final int len) {
