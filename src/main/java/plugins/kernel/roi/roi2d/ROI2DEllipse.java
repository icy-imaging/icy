...
public class ROI2DEllipse extends ROI2DRectShape {
    ...
    public ROI2DEllipse(final Point2D topLeft, final Point2D bottomRight, final boolean cm) {
     ...
     */
    @Deprecated(since = "2.4.3", forRemoval = true)
    public ROI2DEllipse(final Rectangle2D rectangle, final boolean cm) {
        this(rectangle);
    }
     ...
     */
    @Deprecated(since = "2.4.3", forRemoval = true)
    public ROI2DEllipse(final Point2D pt, final boolean cm) {
        this(pt);
    }
